                ...
                <tr key={r.id} className="hover:bg-brand-bg/30 transition-all group">
                  ...
                  <td className="p-8 text-right">
                     <button 
                       ...
                       className="p-2.5 rounded-lg bg-brand-bg text-slate-400 hover:text-orange-500 border border-border-subtle hover:border-orange-200 transition-all"
                     >
                      ...
                      <div className="space-y-3">
                         {selectedSale.items.map((item, idx) => (
                            <div key={idx} className="flex justify-between items-center">
                               ...
                               <p className="text-xs font-black text-foreground">{currency}{(item.price * item.quantity).toLocaleString()}</p>
                            </div>
                         ))}
                      </div>
                   </div>
